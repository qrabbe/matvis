        ...
        <Card.Content>
          <Stack direction="column" gap="md">
            ...
            <Text variant="body-md">
              ...
              auth session, so every write path on the connector rejects it
              before it reaches a handler.
            </Text>
            <Text variant="body-sm">
              It is a bearer credential and it survives closing the tab. Forget
              it on a shared machine. Mint a new one any time in the{' '}
